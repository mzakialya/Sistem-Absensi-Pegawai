                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-name" name="name"  placeholder="Select a value ..."    class="custom-select"  data-url="api/json/users_name_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available">
                                                        ...
                                                        $value = $option['value'];
                                                        $label = $option['label'];
                                                        $selected = $this->set_field_selected('name', $value, "");
                                                        ?>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <div class="dropzone required" input="#ctrl-avatar" fieldname="avatar"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                <input name="avatar" id="ctrl-avatar" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('avatar',"users/default.png"); ?>" type="text"  />
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-government_employee_group_id"  value="<?php  echo $this->set_field_value('government_employee_group_id',""); ?>" type="number" placeholder="Enter Government Employee Group Id" step="1"  required="" name="government_employee_group_id"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-gender_id"  value="<?php  echo $this->set_field_value('gender_id',""); ?>" type="number" placeholder="Enter Gender Id" step="1"  required="" name="gender_id"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-department_id"  value="<?php  echo $this->set_field_value('department_id',""); ?>" type="number" placeholder="Enter Department Id" step="1"  required="" name="department_id"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <textarea placeholder="Enter Settings" id="ctrl-settings"  required="" rows="5" name="settings" class=" form-control"><?php  echo $this->set_field_value('settings',""); ?></textarea>
