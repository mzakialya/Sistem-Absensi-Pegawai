                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-avatar"> Avatar</th>
                                                <th  class="td-phone"> Phone</th>
                                                <th  class="td-nip"> Nip</th>
                                                <th  class="td-government_employee_group_id"> Government Employee Group Id</th>
                                                <th  class="td-gender_id"> Gender Id</th>
                                                ...
                                                <th  class="td-settings"> Settings</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-avatar"><?php Html :: page_img($data['avatar'],50,50,1); ?></td>
                                                    ...
                                                    <td class="td-government_employee_group_id">
                                                        <span  data-value="<?php echo $data['government_employee_group_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-gender_id">
                                                        <span  data-value="<?php echo $data['gender_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="gender_id" 
                                                    ...
                                                    <td class="td-department_id">
                                                        <span  data-value="<?php echo $data['department_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
