...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("role_id","name","email","date_of_birth","avatar","phone","nip","government_employee_group_id","gender_id","department_id","position","status","email_verified_at","password","remember_token","settings","is_active","created_at","updated_at"); //registration fields
