...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.phone LIKE ? OR 
				users.nip LIKE ? OR 
				users.government_employee_group_id LIKE ? OR 
				users.gender_id LIKE ? OR 
				users.department_id LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("role_id","name","email","date_of_birth","avatar","phone","nip","government_employee_group_id","gender_id","department_id","position","status","email_verified_at","password","remember_token","settings","is_active","created_at","updated_at");
