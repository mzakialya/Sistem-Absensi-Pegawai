...
define("SITE_NAME", "Sistem Absensi Pegawai");
...
define("APP_ID", "e464243fdff66b4f8149dd98638de152");
...
define("DB_PASSWORD", "");
define("DB_NAME", "absensi_pegawai");
...
define('USER_ROLE',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id'] : null ));